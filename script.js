...
const greetUser = (name, timeofday) => {
    ...
    else if(timeofday === "afternoon") return "Good afternoon "+ name;
...
const basicCalculator = (num1, num2, operation) => {
    ...
    else if(operation === "add") return num1 + num2;
...
const createUsername = (firstName, lastName) =>{
    ...
    return firstName.substring(0, 3) + lastName.substring(0,3) + totalLength;
}
